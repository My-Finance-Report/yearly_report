        ...
        {step === "init" ? (
          <>
            ...
            <Text mb={6}>
              ...
              account. After enabling, you'll need to enter a verification code
              from your authenticator app when logging in.
            </Text>

            <Box as="form" onSubmit={handleEnable}>
              <Flex gap={2}>
                <Button
                  type="submit"
                  mt={4}
          ...
          <>
            ...
            <Text mb={6}>
              ...
              Authenticator, Authy, or Microsoft Authenticator). After scanning,
              enter the verification code shown in your app.
            </Text>

            <Stack gap={6}>
              <Flex justifyContent="center">
                {qrCode && (
                  <Image src={qrCode} alt="QR Code" maxWidth="200px" />
                )}
              </Flex>
