...
function ShowEffect({ effect }: { effect: EffectOut }) {
  return (
    <Box borderWidth="1px" borderRadius="lg" shadow="md" overflow="hidden">
      ...
      <Flex p={3} borderTopWidth="1px" justify="flex-end">
...
function NotificationPreview({
  ...
  return (
    <Box borderWidth="1px" borderRadius="md" overflow="hidden">
      <Box p={3} borderBottomWidth="1px" fontWeight="medium">
        {subject}
      </Box>
      <Box p={4}>{template}</Box>
    </Box>
  );
}
