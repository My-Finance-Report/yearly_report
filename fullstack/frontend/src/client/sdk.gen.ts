...
export class WorkerStatusService {
     ...
     * @throws ApiError
     */
    public static createSavedFilter(): CancelablePromise<WorkerStatusCreateSavedFilterResponse> {
        return __request(OpenAPI, {
            method: 'POST',
