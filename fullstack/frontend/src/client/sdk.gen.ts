...
export class AccountsService {
     ...
     * @throws ApiError
     */
    public static updateAccountBalance(data: AccountsUpdateAccountBalanceData): CancelablePromise<AccountsUpdateAccountBalanceResponse> {
        return __request(OpenAPI, {
            method: 'PUT',
...
export class NoCodeService {
    ...
    /**
     * Get Parameter
     * @returns Parameter_Output Successful Response
     * @throws ApiError
     */
    public static getParameter(): CancelablePromise<NoCodeGetParameterResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/no_code/parameter'
        });
    }
