...
from app.models import User, Price,  SubscriptionTier
...
def get_subscription_plans(
    ...
    prices = db.query(Price).filter(Price.active == True).all()
    
    # Format prices for frontend
    formatted_prices = []
    for price in prices:
        formatted_prices.append(PriceDetails(
            id=price.id,
...
def cancel_subscription(
    ...
    try:
        ...
        return Message(message="Subscription will be canceled at the end of the billing period")
