...
import type {
  ...
  SavedFiltersReadPublicSavedFiltersData,
  SavedFiltersReadPublicSavedFiltersResponse,
...
||||||| e77b0ff
   ...
   * @throws ApiError
   */
  public static readPublicSavedFilters(
    data: SavedFiltersReadPublicSavedFiltersData = {},
  ): CancelablePromise<SavedFiltersReadPublicSavedFiltersResponse> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/api/v1/saved-filters/public",
      query: {
