...
export class PlaidService {
     ...
     * @throws ApiError
     */
    public static getLinkToken(data: PlaidGetLinkTokenData): CancelablePromise<PlaidGetLinkTokenResponse> {
        return __request(OpenAPI, {
            method: 'POST',
