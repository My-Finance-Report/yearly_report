    ...
    H.div ! A.class_ "auth-container" $ do
      H.div ! A.class_ "auth-section" $ do
        ...
        case errorMsg of
          ...
          Nothing -> return ()
        H.form ! A.method "post" ! A.class_ "flex flex-col justify-center" ! A.action "/login" $ do
          ...
          H.button ! A.type_ "submit" ! A.class_ "primary-button" $ "Login"
      H.div ! A.class_ "auth-divider" $ do
        H.span ""
      H.div ! A.class_ "auth-section" $ do
        H.h1 "Create Account"
        H.form ! A.method "post" ! A.class_ "flex flex-col justify-center" ! A.action "/register" $ do
          H.div ! A.class_ "form-group" $ do
          ...
          H.button ! A.type_ "submit" ! A.class_ "secondary-button" $ "Create Account"
