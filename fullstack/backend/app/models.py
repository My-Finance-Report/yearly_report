...
class Price(Base):
    ...
    recurring_interval: Mapped[str] = mapped_column(String, nullable=False)  # month, year, etc.
...
class Subscription(Base):
    ...
    id: Mapped[SubscriptionId] = mapped_column(Integer, primary_key=True, autoincrement=True)
    user_id: Mapped[UserId] = mapped_column(ForeignKey("user.id"), nullable=False)
    stripe_subscription_id: Mapped[str | None] = mapped_column(String, nullable=True, unique=True)
    stripe_customer_id: Mapped[str | None] = mapped_column(String, nullable=True)
    price_id: Mapped[PriceId | None] = mapped_column(ForeignKey("price.id"), nullable=True)
