    ...
    <Box maxW="800px" mx="auto" py={10} px={6}>
      ...
      <VStack spaceY={6} align="start">
        <Box>
          ...
          <Text>
            Not yet, but soon. With the integration of Plaid, we have started
            building net worth tracking.
          </Text>
        </Box>
        ...
        <Box>
          ...
          <Text>
            Yes, we integrate with Plaid. This should allow most major (and even
            minor) banks to be connected. Let me know if you don't see your bank
            as an option.
          </Text>
        </Box>
        ...
        <Box>
          ...
          <Text>
            Yes, we use Plaid's secure authentication process to link your
            accounts. We cannot generate transfers from your accounts -- just
            read transactions from them.
          </Text>
        </Box>
        <Box>
          <Heading as="h3" size="md">
        ...
        <Box>
          ...
          <Text>
            ...
            <Link
              to="https://github.com/mmc102/yearly_report"
              target="_blank"
